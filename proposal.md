...
| 3–4  | Baseline models (Persistence, Linear)      |
| 5–6  | SSM implementation and training            |
| 7    | Evaluation on validation/test sets         |
| 8    | Prepare final report and presentation      |

---

Let us know if you'd like to add more sections or convert this to PDF or LaTeX for submission.
# Problemsetting AML 2025 Group XX
